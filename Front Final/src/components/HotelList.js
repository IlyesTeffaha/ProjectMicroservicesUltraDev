...
//////////////////////////////////////////////////////////////////////////////
import '../pages/css/HotelList.css'
...
export default () => {
  ...
  useEffect(()=>{
    ...
    const gethotel=async()=>{
      axios.get("http://localhost:8083/hotel/gethotels").then((response)=>{
      if(!iscanceled){
      ...
      <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        ...
        <div className="btn-toolbar mb-2 mb-md-0">
          <ButtonGroup>
            ...
            <Button as={NavLink} to={Routes.AddHotel.path} variant="outline-primary" size="lg">Add Hotel</Button>
          </ButtonGroup>
        </div>
      </div>
...
// const [availability,useAvailability]=useState(false);
 ...
 <div className="posts"> 
  ...
  return(
  <div className="post">
    <NavLink to={`/single-hotel/${value.idHotel}`}>
      <img className="postImg" src={value.image} alt="" />
      </NavLink>
      <div className="postInfo">
  
        <Link to={`/single-hotel/${value.idHotel}`} className="link">
          <span className="postTitle">{value.hotelName}</span>
        </Link>
        <hr />
