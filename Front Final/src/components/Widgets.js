...
/////////////////for reclamation//////////////////
export const ChoosePhotoWidgetreclamation = (props) => {
  const { title, photo } = props;
  const [filepic, setFilepic] = useState(null)
  const [file, setFile] = useState("")
  const [image,setImage]=useState();
...
setAuthState({username:authState.username,
 ...
 reclamationimage:result.info.url})
...
/////////////////for places//////////////////
export const ChoosePhotoWidgetplaces = (props) => {
  const { title, photo } = props;
  const [filepic, setFilepic] = useState(null)
  const [file, setFile] = useState("")
  const [image,setImage]=useState();
...
setAuthState({username:authState.username,
  ...
  gender:authState.gender,
 image:authState.image,
 restaurantimage:result.info.url})
...
////////////////////////////////////////////////
/////////////////for sejour//////////////////
export const ChoosePhotoWidgetsejour = (props) => {
  const { title, photo } = props;
  const [filepic, setFilepic] = useState(null)
  const [file, setFile] = useState("")
  const [image,setImage]=useState();
...
////////////////////////////////////////////////
/////////////////for hotel//////////////////
export const ChoosePhotoWidgethotel = (props) => {
  const { title, photo } = props;
  const [filepic, setFilepic] = useState(null)
  const [file, setFile] = useState("")
  const [image,setImage]=useState();
...
////////////////////////////////////////////////
/////////////////for blog//////////////////
export const ChoosePhotoWidgetblog = (props) => {
  const { title, photo } = props;
  const [filepic, setFilepic] = useState(null)
  const [file, setFile] = useState("")
  const [image,setImage]=useState();
