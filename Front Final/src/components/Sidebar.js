...
import unilogo from '../media/travellogo1.png'
...
const hotel =     <FontAwesomeIcon icon="fa-regular fa-hotel" />
        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          ...
          <div className="sidebar-inner px-4 pt-3">
            ...
            <>
                       ...
                       <NavItem title="Blog" icon={faNewspaper} link={Routes.BlogsList.path} />
                       <NavItem title="Hotels" icon={faHotel} link={Routes.HotelList.path} />
                       <NavItem title="Offers and Promotions" icon={faHandshake} link={Routes.SejourList.path} />
                       <NavItem title="Restaurants and places" icon={faMapMarked} link={Routes.PlacesList.path} />
                       <NavItem title="Clients Reports" icon={faMailBulk} link={Routes.ReclamationsList.path} />
