...
import '../pages/css/SingleSejour.css'
...
import { faWarehouse,faHandshake,faSejour,faMapMarked ,faMailBulk} from '@fortawesome/free-solid-svg-icons'




function SingleSejour() {
    // const [sejourdata,setSejourdata]= useState([]);
    ...
    useEffect(()=>{
        axios.get(`http://localhost:8082/sejour/getsejour/${id}`,{headers:{accessToken:localStorage.getItem("accessToken")},
    }).then((response)=>{
      ...
      const handleUpdate = async () => {
        try {
          await axios.put(`http://localhost:8082/sejour/update-sejour/${id}`, {
            // name:data.name,
            titre:title,
            description:desc,
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`http://localhost:8082/sejour/deletesejour/${id}`, {
        // data: { name: data.name },
      });
      console.log("deleted")
   history.push(Routes.SejourList.path)
...
//                                 <h3 className ="dark-color">{sejourdata.title}</h3>
//                                 {/* <h6 className ="theme-color lead">A Lead UX &amp; UI designer based in Canada</h6>
//                                 <p>I <mark>design and develop</mark> services for customers of all sizes, specializing in creating stylish, modern websites, web services and online stores. My passion is to design digital sejour experiences through the bold interface and meaningful interactions.</p> */}
//                                 <div className ="row about-list">
//                                     <div className ="col-md-6">
//                                     <div className ="media">
//                                             <label>Sejour title</label>
//                                             <p>{sejourdata.title}</p>
//                                         </div>
//                                         <div className ="media">
//                                             <label>Creation Date</label>
//                                             <p>{new Date(sejourdata.creationtime).toDateString()}</p>
//                                         </div>
...
//                                         {/* <div className ="media">
//                                             <label>Address</label>
//                                             <p>{sejourdata.address}</p>
//                                         </div> */}
//                                     </div>
//                                     <div className ="col-md-6">
//                                         {/* <div className ="media">
//                                             <label>E-mail</label>
//                                             <p>{sejourdata.email}</p>
//                                         </div>
//                                         <div className ="media">
//                                             <label>Phone</label>
//                                             <p>{sejourdata.PhoneNumber}</p>
//                                         </div>
//                                         <div className ="media">
//                                             <label>Current Status</label>
//                                             <p>{sejourdata.currentstatus}</p>
//                                         </div> */}
...
//                                 <img src={sejourdata.image} title="" alt=""/>
//                             </div>
//                         </div>
//                     </div>
